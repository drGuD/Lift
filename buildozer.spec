...
requirements = python3, kivy==2.3.0, kivymd, pillow, docutils, kivy-deps.angle, kivy-deps.glew, kivy-deps.sdl2, Kivy-Garden, pygments, pypiwin32, csv, datetime, pandas, numpy, python-dateutil, pytz, tzdata
